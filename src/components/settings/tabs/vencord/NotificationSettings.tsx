    ...
    return (
        <section className={Margins.top16}>
            ...
            <Forms.FormText className={Margins.bottom8}>
                {WIMCORD_UI.notificationsSentBy}.
    ...
    return (
        <>
            ...
            <Forms.FormText className={Margins.bottom8}>
                ...
                <ul>
                    <li><strong>{WIMCORD_BRAND.name} Notifications</strong>: These are in-app notifications</li>
            ...
            <Select
                ...
                options={[
                    ...
                    { label: `Always use ${WIMCORD_BRAND.name} notifications`, value: "never" },
