...
console.log("[Wimcord] Starting up...");
...
if (!IS_VANILLA) {
    ...
    console.log("[Wimcord] Running in vanilla mode. Not loading client mod");
}

console.log("[Wimcord] Loading original Discord app.asar");
