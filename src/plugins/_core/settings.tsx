...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: WIMCORD_UI.settingsLocationDescription,
        options: [
    ...
    includeVencordInfoWhenCopying: {
        ...
        description: WIMCORD_UI.versionInfoDescription,
        default: true
    }
});
...
export default definePlugin({
    ...
    buildLayout(originalLayoutBuilder: SettingsLayoutBuilder) {
        ...
        const vencordEntries: SettingsLayoutNode[] = [
            buildEntry({
                key: "vencord_main",
                title: WIMCORD_BRAND.settingsMainEntryTitle,
            ...
            !IS_UPDATER_DISABLED && UpdaterTab && buildEntry({
                key: "vencord_updater",
                title: "Updater",
                panelTitle: WIMCORD_BRAND.updaterPanelTitle,
            ...
            buildEntry({
                key: "vencord_cloud",
                title: "Cloud",
                panelTitle: WIMCORD_BRAND.cloudPanelTitle,
                Component: CloudTab,
                Icon: CloudIcon
            }),
            buildEntry({
            ...
            !IS_STANDALONE && !WIMCORD_PUBLIC_RELEASE && PatchHelperTab && buildEntry({
        ...
        const vencordSection: SettingsLayoutNode = {
            ...
            useTitle: () => WIMCORD_BRAND.settingsSectionHeading,
    ...
    getInfoRows() {
        ...
        const rows = [`${WIMCORD_BRAND.versionPrefix} ${WIMCORD_BRAND.version} (${gitHash})${additionalInfo}`];
